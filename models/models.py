...
from configs import get_dataset_mean_std


class NormalizationLayer(torch.nn.Module):
    """Normalizes given input using standard score, in the forward part of the network"""
    def __init__(self, dataset):
        super(NormalizationLayer, self).__init__()
        self.mean, self.std = get_dataset_mean_std(dataset)
